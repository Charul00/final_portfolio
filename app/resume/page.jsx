...
const about = {
    ...
    description: "",
    info: [
        { fieldName: "Name", fieldValue: "Charul Chim" },
        
        { fieldName: "Phone", fieldValue: "(+91) 9511618094" },
        { fieldName: "Experience", fieldValue: "1+ years" },
        { fieldName: "Skype", fieldValue: "Charul" },
        { fieldName: "Nationality", fieldValue: "Indian" },
        { fieldName: "Email", fieldValue: "charulchim@gmail.com" },
                    ...
                    <div className="min-h-[70vh] w-full">
                        ...
                        <TabsContent value="skills" className="w-full h-full">
                            <div className="flex flex-col gap-[30px]">
                                ...
                                <ul className="grid grid-col-2 sm:grid-cols-2 sm:grid-cols-3 md:grid-cols-4
                                xl:gap-[30px]">
                                    {
